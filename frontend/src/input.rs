...
use gpui::{
    actions, blue, div, fill, hsla, point, px, rgb, rgba, white, App, AppContext, Bounds,
...
impl TextInput {
    pub fn new(initial: &str, placeholder: &str, masked: bool, cx: &mut App) -> Entity<Self> {
        let initial: SharedString = initial.to_string().into();
...
impl Element for TextElement {
    ...
    fn prepaint(
        ...
        let content = input.displayed_text();
